...
![image of a dragon breathing fire, edited such that the dragon has the label 'Peter Shor', and it's breathing fire on text labels saying g^x, RSA and ECC](PQ-apocalypse.png)
...
![Picture of a development board microcomputer](giant-gecko.webp)
...
![](scatterplot-bb.png){style="height: 30ex"}

</section>
<section>

![](scatterplot-nbiot.png){style="height: 30ex"}
